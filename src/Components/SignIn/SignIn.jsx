...
const SignIn = () => {
    ...
    return (
        <div>
            <div className="hero min-h-screen" style={{ backgroundImage: 'url(https://i.ibb.co.com/61f5wsg/login.jpg)' }}>
                <div className="hero-overlay bg-opacity-60"></div>
                <div className="hero-content text-center text-neutral-content">
                    <div className="w-[650px] bg-white/35 py-8 rounded-xl">
                        ...
                        <h3 className='mb-8 text-black text-2xl '>Already have an Account? <span className='font-bold'><Link to="/signin">Log In Now</Link></span></h3>
                    </div>
                </div>
            </div>
        </div>
